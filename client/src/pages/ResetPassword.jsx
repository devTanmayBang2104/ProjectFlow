          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                type="password"
                required
                className="mt-1 block w-full rounded-lg border border-zinc-300 bg-white/80 px-3 py-2 text-zinc-900 shadow-sm placeholder-slate-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm dark:border-zinc-700 dark:bg-zinc-900/80 dark:text-white"
